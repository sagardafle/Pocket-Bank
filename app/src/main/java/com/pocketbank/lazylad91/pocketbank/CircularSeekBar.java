...
public class CircularSeekBar extends View {
    ...
    protected void init(AttributeSet seekbarattrs, int defStyle) {
        final TypedArray attrArray = getContext().obtainStyledAttributes(seekbarattrs, R.styleable.CircularSeekBar, defStyle, 0);
    ...
    public CircularSeekBar(Context context, AttributeSet seekbarattrs) {
        super(context, seekbarattrs);
        init(seekbarattrs, 0);
    }

    public CircularSeekBar(Context context, AttributeSet seekbarattrs, int defStyle) {
        super(context, seekbarattrs, defStyle);
        init(seekbarattrs, defStyle);
    }
